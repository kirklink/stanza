...
/// Applies migration files and tracks them in an SQLite database.
///
...
class SqliteMigrationRunner {
  ...
  SqliteMigrationRunner(this._db, {required String migrationsDir})
  ...
  Future<List<SqliteMigrationStatus>> status() async {
    ...
    for (final row in result.rows) {
      ...
      applied[row['filename'] as String] = appliedAt is DateTime
          ? appliedAt
          : DateTime.parse(appliedAt as String);
    }
